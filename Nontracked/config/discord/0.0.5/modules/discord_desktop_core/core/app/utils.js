...
function exposeModuleResource(asarPath, fileName) {
  var appPath = _path2.default.resolve(__dirname, '..');
  var fullPathToAsarFile = _path2.default.join(appPath, asarPath, fileName);
  var data = _fs2.default.readFileSync(fullPathToAsarFile);
  var nativeFilePath = _path2.default.join(paths.getUserData(), fileName);
